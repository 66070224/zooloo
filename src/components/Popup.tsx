...
import { aquaAnimalWithID } from "./ModernSearch";
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="w-full h-full flex flex-col items-center shadow-lg bg-gradient-to-r from-[#000b1e] overflow-auto">
              ...
              <h1 className="text-5xl font-bold text-white mt-4 uppercase tracking-widest place-self-start px-6">
                {animaldata.name}
              </h1>
              <h2 className="place-self-start px-6 italic">
                "{" "}
                {animaldata.nickname != "None"
                  ? animaldata.nickname
                  : animaldata.name + " of the Sea"}{" "}
                "
              </h2>
              <h3 className="place-self-start px-6 mb-2">
                {animaldata.detail}
              </h3>
              ...
              <div className="flex gap-4 mt-6 mb-8">
                <SubCard label={"Speed"} value={animaldata.statistics.speed} />
                <SubCard label={"Size"} value={animaldata.statistics.size} />
                <SubCard
                  label={"Weight"}
                  value={animaldata.statistics.weight}
                />
                <SubCard
                  label={"Life Span"}
                  value={animaldata.statistics.lifespan}
                />
              </div>
            </div>
          </motion.div>
